    ...
    *,
    ...
    payload = {
        "run_info": {
            ...
            "active_regions": run_config.get("active_regions", []),
            "scope_mode": run_config.get("scope_mode"),
            "news_scope": run_config.get("news_scope"),
            "is_global_scope": bool(run_config.get("is_global_scope", False)),
            "region_filter_enabled": bool(run_config.get("region_filter_enabled", False)),
        ...
        "stats": {
            ...
            "forward_gate_failure_reason_counts": latest_stats.get("forward_gate_failure_reason_counts", debug_info.get("pipeline_debug_stats", {}).get("forward_gate_failure_reason_counts", {})),
            "forward_gate_pass_ids": latest_stats.get("forward_gate_pass_ids", debug_info.get("pipeline_debug_stats", {}).get("forward_gate_pass_ids", [])),
            "forward_gate_pass_titles": latest_stats.get("forward_gate_pass_titles", debug_info.get("pipeline_debug_stats", {}).get("forward_gate_pass_titles", [])),
            "forward_selected_ids": latest_stats.get("forward_selected_ids", debug_info.get("pipeline_debug_stats", {}).get("forward_selected_ids", [])),
            "forward_selected_titles": latest_stats.get("forward_selected_titles", debug_info.get("pipeline_debug_stats", {}).get("forward_selected_titles", [])),
