...
INTERNATIONAL_ELECTROMECHANICAL_PROCUREMENT_QUERY_BUDGET = 5
PROCUREMENT_RESCUE_BUDGET_BY_PERIOD = {
    "weekly": 3,
    "monthly": 4,
    "annual": 5,
}
...
FORMAL_REPORT_CATEGORY_MAP = {
    ...
    SERVICE_OPENING_CATEGORY_KEY: OPERATIONAL_DYNAMICS_CATEGORY_LABEL,
}
...
SERVICE_OPENING_ACTUAL_TERMS = [
    ...
    "open for passenger service", "opened for passenger services",
    ...
    "passenger service commenced", "passenger services commenced",
    "commenced passenger service", "commenced passenger services",
    "passenger service began", "passenger services began",
    "entered passenger service", "entered passenger services",
    "began carrying passengers", "began carrying passenger",
    "passenger service has begun", "passenger services have begun",
    "passenger service has commenced", "passenger services have commenced",
    "officially begun passenger service", "officially began passenger service",
    "officially entered passenger service", "service has commenced",
    "service has officially commenced",
    ...
    "service begins", "service began", "service has begun",
    "service has officially begun", "service officially began",
...
SERVICE_OPENING_FUTURE_TERMS = [
    ...
    "will commence passenger service", "will commence passenger services",
    "plans to commence passenger service", "plans to commence passenger services",
    "scheduled to commence passenger service", "scheduled to commence passenger services",
    "passenger service will begin", "passenger services will begin",
    "service will begin", "service will commence",
    "will enter passenger service", "will enter passenger services",
    "planned to enter service", "planned to enter passenger service",
...
SERVICE_OPENING_PLANNING_TERMS = [
    ...
    "opening planned", "service opening planned", "planned opening",
    "under construction", "construction underway", "opening is planned",
    "service opening is planned",
...
SERVICE_OPENING_TESTING_TERMS = [
    ...
    "trial operation begins", "test trains entered the line",
...
METRO_SYSTEM_OWNERSHIP_RULES = (
    {
        "region": "Indonesia",
        "location_aliases": ("jakarta", "jakarta mrt", "mrt jakarta"),
        "operator_aliases": ("jakarta mrt", "mrt jakarta", "pt mrt jakarta"),
