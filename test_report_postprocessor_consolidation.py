...
EXPECTED_SCENARIO_SHA256 = {
    "weekly_without_journal": (
        "15b9172bc04f496e34e338bc797f2cc17e4bc6207e5be3880d164ad85b6b5b8a"
    ),
    "weekly_with_journal": (
        "db6e17a4cc852cc9c98bb52e20048d3324ce8dda405a693f3b5e30200f26954e"
    ),
    "annual_with_journal": (
        "fc91f3e809b2c00ee2957efa3f2752ccd97e76047303ca3111a824ba91fa61a8"
    ),
}
EXPECTED_AGGREGATE_SHA256 = (
    "e07bd017d4185924ae135c19047a953917e7d3ad01938431a81cae71636c9da3"
)
...
class ConsolidatedReportPostprocessorGoldenTests(unittest.TestCase):
    ...
    def test_all_postprocessing_stages_match_pre_split(self):
        ...
        self.assertNotIn("學術期刊綜合結論", annual["final_report"])
        self.assertEqual([item["candidate_id"] for item in annual["dropped_candidates"]], [2])
        self.assertFalse(annual["id_reconciliation"]["after_reconcile"]["valid"])
